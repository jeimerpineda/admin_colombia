...
@section('title') Agregar Tipo de Documento @endsection
@section('content')
	{!!\Basics::Breadcrumb(['Configuración','Tipo de Documento','Agregar'])!!}
	...
	<div class="col-xs-6 col-md-6 offset-md-3 offset-xs-3">
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<form action="{{route('config.tipodocumento.insert.form')}}" id="form_tipodocumento" method="POST" class="col-md-8 col-xs-6 col-form-label offset-md-2 offset-xs-3">
					@csrf
