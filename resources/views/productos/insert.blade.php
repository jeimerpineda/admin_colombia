	...
	<div class="col-12 offset-20">
		<div class="card">
			...
			<div class="card-body">
				...
				<form action="{{route('config.productos.insert.form')}}" id="form_productos" method="POST" class="col-12 offset-20">
					@csrf
					<div class="row">
  						<div class="col-sm-6">
    						<div class="card">
     						 <div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-9">
										<input required type="text" name="descripcion" class="form-control" pattern="^[a-z]{20}" title="solo acepto letras" value="{{old('descripcion')}}">
									</div>
								</div>
								<div class="form-group row">
