...
@section('content')
	...
	<div class="container-fluid">
		<div class="btn-group d-flex justify-content-end mb-3">
			<a href="{{route('config.impuesto.insert')}}" class="btn btn-dark btn-sm">
					...
					<tbody>
						@foreach($impuestos as $impuesto)
							<tr>
								...
								<td>
									<div class="btn-group">
										<a href="{{route('config.impuesto.update',['impuestos_id'=>$impuesto->id])}}" class="btn btn-outline-primary btn-sm">
											<i class="fa fa-edit"></i>
										</a>
										<a href="{{route('config.impuesto.delete',['impuestos_id'=>$impuesto->id])}}" class="btn btn-outline-danger btn-sm">
